  ...
  return (
    <div className='h-[75px] flex justify-around items-center shadow'>
        ...
        <div>
            ...
            <button className='bg-blue-100 text-blue-400 px-3 py-1 rounded mr-2'>Login / Register</button>
            <button className='bg-blue-500 text-white px-3 py-1 rounded'>Job Post</button>
        </div>
    </div>
  )
}
